    ...
    if (user) {
      ...
      message.reply({
        embeds: [new MessageEmbed()
          ...
          .setFooter(client.getFooter(`${user.username} | Ordinarys Discord Server`, "https://cdn.discordapp.com/attachments/938468051123314808/962616571673604176/vibesid-19032022-0001.jpg"))
        ],
